...
**hello-rails-back-end** Is a Rails app that serves data from a PostgreSQL database to [hello-react-frontend ](https://github.com/noelfoka/hello-rails-frontend) React frontend App in JSON format through an API endpoint.
...
Use the following URL to clone this project:
   ...
   https://github.com/noelfoka/hello-rails-backend.git
...
Open [http://localhost:3000](http://localhost:3000/greetings/random_greeting) to view it in your browser.
